// Crear mapa base
var map = L.map('map').setView([-22.4686, -69.0143], 10); // ajusta a tu zona
...
// Función para parsear CSV simple (asumiendo columnas: system:time_start, NDVI)
  ...
  fetch(url)
    ...
    .then(text => {
      ...
      for (var i = 1; i < lines.length; i++) {
        ...
        var fecha = new Date(cols[timeIdx]);
